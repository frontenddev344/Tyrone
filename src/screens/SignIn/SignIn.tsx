    ...
    <div className="min-h-screen flex flex-col lg:flex-row w-full">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-gray-50 px-4 sm:px-8 lg:px-12 py-8 lg:py-12">
        <form onSubmit={handleSignIn} className="w-full max-w-[597px] mx-auto">
          {/* Heading */}
          <h2 className="text-[#111827] text-[24px] sm:text-[28px] lg:text-[30px] font-bold mb-3 leading-tight">Welcome back</h2>
          <p className="text-[#4B5563] text-[14px] sm:text-[15px] lg:text-[16px] mb-6 lg:mb-4 font-light">Sign in to your Transify account to continue</p>
          {/* Email */}
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <Input className="pl-10 h-[45px] rounded-xl text-[15px] sm:text-[16px] lg:text-[17px] border border-[#D1D5DB] focus:border-green-400" placeholder="Enter your email" type="email" required />
            </div>
          </div>
          {/* Password */}
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <Input type="password" className="pl-10 h-[45px] rounded-xl text-[15px] sm:text-[16px] lg:text-[17px] border border-[#D1D5DB] focus:border-green-400" placeholder="Enter your password" required />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 pt-1 mb-5">
            <div className="flex items-center space-x-3">
              <Checkbox id="remember" className="rounded border-gray-300 mt-1 flex-shrink-0" />
              <label htmlFor="remember" className="text-[#4B5563] text-[13px] sm:text-[14px] lg:text-[15px] font-normal">
                Remember me
              </label>
            </div>
            <button type="button" className="text-[#32CD32] text-[13px] sm:text-[14px] lg:text-[15px] font-semibold hover:underline sm:ml-auto">Forgot password?</button>
          </div>
          {/* Sign In Button */}
          <Button type="submit" className="w-full px-6 h-[45px] bg-[#32CD32] hover:bg-[#2db82d] rounded-[10px] font-medium text-[15px] sm:text-[16px] lg:text-[17px] text-white flex items-center justify-center transition-colors shadow-none mb-5">
            Sign In
          </Button>
          {/* Divider */}
